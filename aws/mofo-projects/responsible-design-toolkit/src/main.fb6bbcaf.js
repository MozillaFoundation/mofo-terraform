...
(function ($, root, undefined) {
  $(function () {
    ...
    var menuItems = $(".inpage-nav").find("a"); // Anchors corresponding to menu items
    ...
    $(window).scroll(function () {
      ...
      var fromTop = $(this).scrollTop() + 230; // Get id of current scroll item
    ...
    console.log("h2 bototm: " + bottom); // inpage nav stick to bottom of div

    window.addEventListener('scroll', function (e) {// console.log( $(window).scrollTop() );
