...
resource "heroku_app" "foundation-site-proxy-test" {
  name   = "foundation-site-proxy-test"
  region = "us"
  ...
  config_vars = {
    ALLOWED_HOSTS                      = "proxy-test.mofostaging.net,proxy-test-two.mofostaging.net,foundation-site-proxy-test.herokuapp.com",
    ASSET_DOMAIN                       = "proxy-test.mofostaging.net",
    ...
    NETWORK_SITE_URL                   = "https://foundation-site-proxy-test.herokuapp.com",
    ...
    TARGET_DOMAINS                     = "proxy-test.mofostaging.net,proxy-test-two.mofostaging.net",
    USE_CLOUDINARY                     = "True",
    USE_S3                             = "True",
...
resource "heroku_addon" "redis" {
  app  = heroku_app.foundation-site-proxy-test.name
...
resource "heroku_domain" "custom-domain" {
  app      = heroku_app.foundation-site-proxy-test.name
  hostname = "proxy-test.mofostaging.net"
}

resource "heroku_domain" "second-custom-domain" {
  app      = heroku_app.foundation-site-proxy-test.name
  hostname = "proxy-test-two.mofostaging.net"
}
...
resource "heroku_drain" "scalyr-drain" {
  app = heroku_app.foundation-site-proxy-test.name
  url = var.scalyr_drain
}
