resource "heroku_app" "foundation-homepage-refresh" {
  name   = "foundation-homepage-refresh"
  region = "us"
  ...
  config_vars = {
    ALLOWED_HOSTS                      = "homepage-refresh.mofostaging.net,foundation-homepage-refresh.herokuapp.com,mozillafestival-homepage-refresh.mofostaging.net",
    ASSET_DOMAIN                       = "homepage-refresh.mofostaging.net",
    ...
    NETWORK_SITE_URL                   = "https://foundation-homepage-refresh.herokuapp.com",
    ...
    TARGET_DOMAINS                     = "homepage-refresh.mofostaging.net",
    USE_CLOUDINARY                     = "True",
    USE_S3                             = "True",
...
resource "heroku_addon" "redis" {
  app  = heroku_app.foundation-homepage-refresh.name
...
resource "heroku_domain" "custom-domain" {
  app      = heroku_app.foundation-homepage-refresh.name
  hostname = "homepage-refresh.mofostaging.net"
}

resource "heroku_domain" "custom-domain-mozfest" {
  app      = heroku_app.foundation-homepage-refresh.name
  hostname = "mozillafestival-homepage-refresh.mofostaging.net"
}
